...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "conflict.detected": "Modified files detected:",
    "conflict.prompt": "Choose conflict resolution:",
    "conflict.force": "Force overwrite all conflicting files",
    "conflict.skip": "Skip conflicting files",
    "conflict.backup": "Backup then overwrite",
    "conflict.abort": "Abort distribution",
    "conflict.aborted": "Distribution aborted",
    "conflict.input": "Enter option (1-4): ",
    "conflict.invalid": "Invalid option, enter 1-4",
    "conflict.hash_old": "Original",
    "conflict.hash_new": "Current",
  ...
  "zh-TW": {
    ...
    "conflict.detected": "偵測到以下檔案已被修改：",
    "conflict.prompt": "請選擇處理方式：",
    "conflict.force": "強制覆蓋所有衝突檔案",
    "conflict.skip": "跳過衝突檔案",
    "conflict.backup": "備份後覆蓋",
    "conflict.abort": "取消分發",
    "conflict.aborted": "已取消分發",
    "conflict.input": "請輸入選項 (1-4): ",
    "conflict.invalid": "無效選項，請輸入 1-4",
    "conflict.hash_old": "原始",
    "conflict.hash_new": "目前",
