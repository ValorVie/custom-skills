...
description: MCP Server 個別使用指南索引，各服務的深入安裝說明與使用範例
---

# MCP Server 使用指南

本目錄收錄各 MCP Server 的**深入使用指南**。快速安裝設定請參閱上層的 [MCP-SERVER-GUIDE.md](../MCP-SERVER-GUIDE.md)。

---

## 指南清單

| MCP Server | 用途 | Stars | 授權 | 指南 |
|------------|------|-------|------|------|
...
- [mcp-configs/](../mcp-configs/) — Claude Code / OpenCode 設定範本
