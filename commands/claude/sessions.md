...
```bash
node -e "
const sm = require(require('path').join(process.env.CLAUDE_PLUGIN_ROOT || require('path').join(require('os').homedir(), '.claude', 'plugins', 'ecc-hooks'), 'scripts', 'lib', 'session-manager'));
const aa = require(require('path').join(process.env.CLAUDE_PLUGIN_ROOT || require('path').join(require('os').homedir(), '.claude', 'plugins', 'ecc-hooks'), 'scripts', 'lib', 'session-aliases'));
