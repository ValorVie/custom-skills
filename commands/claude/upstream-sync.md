...
```bash
python skills/upstream-sync/scripts/sync_upstream.py --check
```
...
```bash
python skills/upstream-sync/scripts/sync_upstream.py --full
```
...
/upstream-sync --full --source everything-claude-code
