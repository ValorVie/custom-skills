...
**Added (2):**
- skills/custom-skills-git-commit/pr.md
- skills/custom-skills-git-commit/pr-analyze.md

**Modified (2):**
- skills/custom-skills-git-commit/SKILL.md
- commands/claude/custom-skills-git-commit.md
